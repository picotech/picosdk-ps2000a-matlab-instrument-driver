function [methodinfo,structs,enuminfo,ThunkLibName]=ps2000aWrapMFile_glnxa64
%PS2000AWRAPMFILE_GLNXA64 Create structures to define interfaces found in 'ps2000aWrap'.

%This function was generated by loadlibrary.m parser version  on Tue Jan 31 16:40:33 2017
%perl options:'ps2000aWrap.i -outfile=ps2000aWrapMFile_glnxa64.m -thunkfile=ps2000aWrap_thunk_glnxa64.c -header=ps2000aWrap.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'ps2000aWrap_thunk_glnxa64');
...
% extern int32_t AvailableData ( int16_t handle , uint32_t * startIndex ); 
...
% extern PICO_STATUS setChannelCount ( int16_t handle ); 
...
% extern PICO_STATUS setAppAndDriverDigiBuffers ( int16_t handle , int16_t digiPort , int16_t * appDigiBuffer , int16_t * driverDigiBuffer , int32_t bufferLength ); 
...
% extern PICO_STATUS setMaxMinAppAndDriverDigiBuffers ( int16_t handle , int16_t digiPort , int16_t * appMaxDigiBuffer , int16_t * appMinDigiBuffer , int16_t * driverMaxDigiBuffer , int16_t * driverMinDigiBuffer , int32_t bufferLength ); 
